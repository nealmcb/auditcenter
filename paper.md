# Reconstructing, Cleaning, and Measuring the Coverage of a Decade of Colorado's Public Risk-Limiting Audit Data

*Anonymous submission to EVT/WOTE 2026.*

## Abstract

Colorado has run a mandatory, statewide risk-limiting audit after every
election since 2017. We reconstruct, clean, and normalize ten years of
the state's public audit exports into a single dataset, verify it
against an independent ground truth, and report the resulting
structural coverage and discrepancy findings.

## Acknowledgments

Data reconstruction, analysis code, and drafting were substantially
aided by generative AI assistants (Anthropic's Claude and OpenAI's
ChatGPT) under continuous human direction and review. Source code
reproducing the normalized dataset and every result in this paper is
this repository itself; see `README.md` and `reproduce_paper.ipynb`.
...
## 3.5 Normalized schema for TODO 
...
- **[corlasoftware]** {Colorado Department of State}. "{CORLA} (Colorado Risk-Limiting Audit Tool) source code." .
- **[corstatute]** {State of Colorado}. "Colorado Revised Statutes {\S} 1-7-515: Risk-limiting audits -- rules -- legislative declaration -- definitions." .
- **[corules2026]** {Colorado Secretary of State}. "Election Rules, 8 {CCR} 1505-1, Rule 25 (Risk-Limiting Audits)." .
- **[glazer2021style]** Glazer, Amanda K. and Spertus, Jacob V. and Stark, Philip B.. "More Style, Less Work: Card-style Data Decrease Risk-limiting Audit Sample Sizes." . https://dl.acm.org/doi/10.1145/3457907
- **[lindeman2012bravo]** Lindeman, Mark and Stark, Philip B. and Yates, Vincent S.. "{BRAVO}: Ballot-polling Risk-limiting Audits to Verify Outcomes." . https://www.usenix.org/system/files/conference/evtwote12/evtwote12-final27.pdf
- **[lindeman2012gentle]** Lindeman, Mark and Stark, Philip B.. "A Gentle Introduction to Risk-Limiting Audits." . https://www.stat.berkeley.edu/~stark/Preprints/gentle12.pdf
- **[lindeman2013retabulation]** Lindeman, Mark and Rivest, Ronald L. and Stark, Philip B.. "Machine Retabulation is not Auditing." . https://www.stat.berkeley.edu/~stark/Preprints/retabNotAudit13.pdf
- **[lindeman2018nextsteps]** Lindeman, Mark and McBurnett, Neal and Ottoboni, Kellie and Stark, Philip B.. "Next Steps for the {C}olorado {R}isk-{L}imiting {A}udit ({CORLA}) Program." . https://arxiv.org/abs/1803.00698
- **[nas2018securing]** {National Academies of Sciences, Engineering, and Medicine}. "Securing the Vote: Protecting American Democracy." . https://doi.org/10.17226/25120
- **[nas2023moving]** {National Academies of Sciences, Engineering, and Medicine}. "Moving to Evidence-Based Elections." . https://www.nationalacademies.org/news/2023/03/moving-to-evidence-based-elections
- **[ottoboni2018suite]** Ottoboni, Kellie and Stark, Philip B. and Lindeman, Mark and McBurnett, Neal. "Risk-Limiting Audits by Stratified Union-Intersection Tests of Elections ({SUITE})." . https://arxiv.org/abs/1809.04235
- **[rivest2018consistent]** Rivest, Ronald L.. "Consistent Sampling with Replacement." . https://arxiv.org/abs/1808.10016
- **[rlaworkinggroup2012]** {Risk-Limiting Audits Working Group}. "Risk-Limiting Post-Election Audits: Why and How." . https://www.stat.berkeley.edu/~stark/Preprints/RLAwhitepaper12.pdf
- **[stark2008conservative]** Stark, Philip B.. "Conservative Statistical Post-Election Audits." . https://projecteuclid.org/euclid.aoas/1215118528
- **[stark2010supersimple]** Stark, Philip B.. "Super-Simple Simultaneous Single-Ballot Risk-Limiting Audits." . https://www.stat.berkeley.edu/~stark/Preprints/superSimple10.pdf
- **[stark2012evidence]** Stark, Philip B. and Wagner, David A.. "Evidence-Based Elections." . https://www.stat.berkeley.edu/~stark/Preprints/evidenceVote12.pdf
